package crc648c0d2c97cf7e0dfb;


public class HingeSensor_HingeSensorEventListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Device.Display.HingeSensor+HingeSensorEventListener, Xamarin.DuoSdk", HingeSensor_HingeSensorEventListener.class, __md_methods);
	}


	public HingeSensor_HingeSensorEventListener ()
	{
		super ();
		if (getClass () == HingeSensor_HingeSensorEventListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Device.Display.HingeSensor+HingeSensorEventListener, Xamarin.DuoSdk", "", this, new java.lang.Object[] {  });
	}
